...
public class GNSDK {
  ...
  public GNSDK(String libPath, String javaLibPath, String clientId, String clientIdTag,
      String license) {
    ...
    try {
      ...
      GnManager gnManager =
          new GnManager(libPath, license, GnLicenseInputMode.kLicenseInputModeString);
      ...
      GnLocale locale =
          new GnLocale(GnLocaleGroup.kLocaleGroupMusic, GnLanguage.kLanguageEnglish,
              GnRegion.kRegionDefault, GnDescriptor.kDescriptorSimplified, gnUser);
  ...
  public void lookupStream(String path, TempFile file, IProcessLookupResponse callback) {
    try {
      ...
      GnMusicIdStream idStream =
          new GnMusicIdStream(gnUser, GnMusicIdStreamPreset.kPresetRadio,
              new IGnMusicIdStreamEvents() {
                ...
                public void musicIdStreamAlbumResult(GnResponseAlbums response, IGnCancellable arg1) {
                  try {
                    ...
                    while (itr.hasNext()) {
                      ...
                      tracks[matchCounter] =
                          new Track(album.artist().name().display(), track.artist().name()
                              .display(), track.title().display(), track.duration());
                      matchCounter++;
                    }
                ...
                @Override
                public void musicIdStreamIdentifyingStatusEvent(
                    GnMusicIdStreamIdentifyingStatus arg0, IGnCancellable arg1) {
                  // TODO Auto-generated method stub

                }

                @Override
                public void musicIdStreamProcessingStatusEvent(
                    GnMusicIdStreamProcessingStatus arg0, IGnCancellable arg1) {
                  // TODO Auto-generated method stub

                }

                @Override
                public void statusEvent(GnStatus arg0, long arg1, long arg2, long arg3,
                    IGnCancellable arg4) {
                  // TODO Auto-generated method stub
